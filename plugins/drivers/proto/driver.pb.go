...
type Device struct {
	...
	// Type is the device type.  Together with major/minor can be used
	// to match devices instead of `host_path`.  Supported values are:
	//   - b - block device
	//   - c - char device
	//   - p - FIFO device
	Type string `protobuf:"bytes,4,opt,name=type,proto3" json:"type,omitempty"`
	// Major is the device node major number, -1 for "wildcard", must be
	// used together with non-empty `type`, and is ignored otherwise.
	Major int64 `protobuf:"varint,5,opt,name=major,proto3" json:"major,omitempty"`
	// Minor is the device node minor number, -1 for "wildcard", must be
	// used together with non-empty `type`, and is ignored otherwise.
	Minor                int64    `protobuf:"varint,6,opt,name=minor,proto3" json:"minor,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_4a8f45747846a74d = []byte{
	...
	,
}
